...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_KEYS.DATABASE_NAME, null, DATABASE_KEYS.DATABASE_VERSION) {
    ...
    object DATABASE_KEYS{
        ...
        const val COLUMN_VOTO_CODIGO_ESTUDANTE = "codigo_estudante"
    }
    ...
    private companion object{
        ...
        const val CREATE_VOTO_TABLE = "CREATE TABLE ${DATABASE_KEYS.TABLE_VOTO_NAME} (" +
                ...
                "${DATABASE_KEYS.COLUMN_VOTO_CODIGO_ESTUDANTE} TEXT NOT NULL, " +
                "PRIMARY KEY (${DATABASE_KEYS.COLUMN_VOTO_CODIGO}, ${DATABASE_KEYS.COLUMN_VOTO_CODIGO_ESTUDANTE}), " +
                "FOREIGN KEY (${DATABASE_KEYS.COLUMN_VOTO_CODIGO_ESTUDANTE}) REFERENCES ${DATABASE_KEYS.TABLE_ESTUDANTE_NAME} (${DATABASE_KEYS.COLUMN_ESTUDANTE_PRONTUARIO}))"
